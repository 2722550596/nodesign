...
export const ENV_KEYS = Object.freeze([
  { key: 'ANTHROPIC_API_KEY', group: '模型', label: 'Anthropic API Key', secret: true, hint: '不填则用本机 claude login 的订阅登录态；填了 CLI 就走 API 计费' },
  ...
  { key: 'NODESIGN_IMAGE_PROVIDER', group: '生图', label: '生图通道', secret: false, options: ['codex', 'gateway'], hint: 'codex = 本机 codex CLI（需 codex login）；gateway = 下面的网关钥匙' },
  { key: 'NODESIGN_GATEWAY_KEY', group: '生图', label: '网关 Key', secret: true },
  { key: 'NODESIGN_GATEWAY_URL', group: '生图', label: '网关 URL', secret: false },
  { key: 'NODESIGN_CODEX_BIN', group: '生图', label: 'codex 可执行路径', secret: false, hint: '不在 PATH 时填绝对路径' },
